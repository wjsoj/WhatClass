...
export default function RoomPage() {
  ...
  return (
    <>
      ...
      <div className="flex flex-row space-x-6 justify-center items-center mx-10">
        <Label className="ml-2 shrink-0 text-lg">视图：</Label>
        <Select value={isEmptyView} onValueChange={(e)=>{setIsEmptyView(e)}}>
          <SelectTrigger>
            <SelectValue placeholder="选择视图模式" />
          </SelectTrigger>
          <SelectContent>
            <SelectGroup>
              <SelectItem value="false">全部教室信息</SelectItem>
              <SelectItem value="true">仅空闲教室</SelectItem>
            </SelectGroup>
          </SelectContent>
        </Select>
      </div>
